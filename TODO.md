...
|---|--------|--------|--------|-------|
| 1 | **Git context** | High | Low | Just shells out to git commands, formats output. No DB needed. |
...
| 9 | **Scratch pad** | Medium | Low-Med | SQLite or flat files, section CRUD. Simple but needs design. |
